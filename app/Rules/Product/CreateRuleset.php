...
class CreateRuleset implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $this->validator = Validator::make($value, [
            'product_id' => ['required', 'integer', ExtendedRule::unique('product', 'source_id')->where(function ($query) {
            ...
            'product_id.unique' => 'The :attribute is already taken.',
        ]);
