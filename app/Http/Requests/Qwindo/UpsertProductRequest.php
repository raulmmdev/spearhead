...
use App\Rules\Product\UpsertProductRequest as UpsertRuleset;

/**
 * UpsertProductRequest
 */
class UpsertProductRequest extends ApiRequest implements ResolvableInterface
{
    //------------------------------------------------------------------------------------------------------------------
    // PROPERTIES
    //------------------------------------------------------------------------------------------------------------------
    ...
    {
        return [
            'product' => ['required', 'array', 'min:1', new UpsertRuleset],
        ];
    }
