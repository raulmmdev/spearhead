...
use App\Rules\Product\CreateRuleset;

/**
 * CreateProductRequest
 */
class CreateProductRequest extends ApiRequest implements ResolvableInterface
{
    //------------------------------------------------------------------------------------------------------------------
    // PROPERTIES
    //------------------------------------------------------------------------------------------------------------------
    ...
    {
        return [
            'product' => ['required', 'array', 'min:1', new CreateRuleset],
        ];
    }
